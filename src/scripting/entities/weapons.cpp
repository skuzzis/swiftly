...
LoadScriptingComponent(weapons, [](PluginObject plugin, EContext* ctx) -> void {
    ...
    ADD_CLASS_FUNCTION("Weapon", "GetCBasePlayerWeapon", [](FunctionContext* context, ClassData* data) -> void {
        context->SetReturn(MakeSDKClassInstance("CBasePlayerWeapon", data->GetData<void*>("ptr"), context->GetPluginContext()));
    });

    ADD_CLASS_FUNCTION("Weapon", "GetCCSWeaponBase", [](FunctionContext* context, ClassData* data) -> void {
        context->SetReturn(MakeSDKClassInstance("CCSWeaponBase", data->GetData<void*>("ptr"), context->GetPluginContext()));
    });

    ADD_CLASS_FUNCTION("Weapon", "GetCBasePlayerWeaponVData", [](FunctionContext* context, ClassData* data) -> void {
        context->SetReturn(MakeSDKClassInstance("CBasePlayerWeaponVData", data->GetData<void*>("ptr"), context->GetPluginContext()));
    });

    ADD_CLASS_FUNCTION("Weapon", "GetCCSWeaponBaseVData", [](FunctionContext* context, ClassData* data) -> void {
